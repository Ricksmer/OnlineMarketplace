...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="welcome-banner">
            <div>
                <h1>
                    Welcome back, 
                    <?php echo isset($_SESSION['uname']) ? htmlspecialchars($_SESSION['uname']) : 'Seller'; ?>!
                </h1>
        ...
        <div class="action-grid">
            ...
            <div class="action-card seller-card">
                ...
                <button class="card-btn" onclick="location.href='add-product.php'">
                    Go to Add Product
                </button>
            </div>
            ...
            <div class="action-card seller-card">
                ...
                <button class="card-btn" onclick="location.href='add-voucher.php'">
                    Go to Add Voucher
                </button>
            </div>
    ...
    <p class="section-title table-title">Payment Records</p>

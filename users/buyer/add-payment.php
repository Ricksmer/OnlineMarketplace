...
<nav class="navbar">
    <a href="buyer-interface.php" class="nav-logo">
        <span class="logo-icon">OM</span>
        Online Marketplace
    </a>
    <div class="nav-badge">Buyer Portal</div>
</nav>
...
<div class="page-wrapper">
    <div class="action-card">
        ...
        <div class="welcome-banner">
            ...
            <span class="role-badge">PAYMENT</span>
        </div>
                ...
                <select name="voucherID">
                    ...
                    <?php while ($voucher = mysqli_fetch_assoc($voucherResult)): ?>
                        <option value="<?php echo $voucher['VoucherID']; ?>">
                            ...
                            —
                            $<?php echo number_format($voucher['DiscountAmount'], 2); ?> off
                        </option>
                    <?php endwhile; ?>
                </select>
            </div>
        ...
        <a href="buyer-interface.php" class="back-link">← Go Back</a>
